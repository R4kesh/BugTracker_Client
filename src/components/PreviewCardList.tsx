...
export function PreviewCardList() {
  const { epicId,Id } = useParams<{ epicId?: string,Id?: string }>(); // Specify epicId as optional
          ...
          currentTasks.map((task) => (
            ...
            >
              <div className="p-6">
                ...
                <div className="text-sm font-medium mb-4">
                  <p>Status:</p>
                <Link to={`/tasktracking/${task.id}`}> <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300"
